...
MariaDB [CSD2204S18]> select department_id, departmemt_name from departments where department_name like 'IT%';
ERROR 1054 (42S22): Unknown column 'departmemt_name' in 'field list'
...
MariaDB [CSD2204S18]> select first_name,last_name , department_id from employees where department_id =(select department_id from departments where department_name like 'IT%');
...
MariaDB [CSD2204S18]> select  employee_id,first_name,manager_id from employees limit 10;
+-------------+------------+------------+
...
MariaDB [CSD2204S18]> select  first_name from employees  where employee_id WHERE manager_id!=0;\
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'WHERE manager_id!=0' at line 1
MariaDB [CSD2204S18]> select  first_name from employees  where employee_id WHERE manager_id!=0;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'WHERE manager_id!=0' at line 1
MariaDB [CSD2204S18]> select  manager_id  from employees  where employee_id WHERE manager_id!=0;
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'WHERE manager_id!=0' at line 1
...
MariaDB [CSD2204S18]> select * from employees limit 2;
+-------------+------------+-----------+----------+--------------+------------+---------+----------+----------------+------------+---------------+
| EMPLOYEE_ID | FIRST_NAME | LAST_NAME | EMAIL    | PHONE_NUMBER | HIRE_DATE  | JOB_ID  | SALARY   | COMMISSION_PCT | MANAGER_ID | DEPARTMENT_ID |
+-------------+------------+-----------+----------+--------------+------------+---------+----------+----------------+------------+---------------+
|         100 | Steven     | King      | SKING    | 515.123.4567 | 1987-06-17 | AD_PRES | 24000.00 |           0.00 |          0 |            90 |
...
MariaDB [CSD2204S18]> select * from employees limit 4;
+-------------+------------+-----------+----------+--------------+------------+---------+----------+----------------+------------+---------------+
| EMPLOYEE_ID | FIRST_NAME | LAST_NAME | EMAIL    | PHONE_NUMBER | HIRE_DATE  | JOB_ID  | SALARY   | COMMISSION_PCT | MANAGER_ID | DEPARTMENT_ID |
+-------------+------------+-----------+----------+--------------+------------+---------+----------+----------------+------------+---------------+
|         100 | Steven     | King      | SKING    | 515.123.4567 | 1987-06-17 | AD_PRES | 24000.00 |           0.00 |          0 |            90 |
...
MariaDB [CSD2204S18]> select first_name,job_id from employees;
+-------------+------------+
| first_name  | job_id     |
+-------------+------------+
| Steven      | AD_PRES    |
...
MariaDB [CSD2204S18]> select first_name,last_name,salary,job_id  from employees WHERe employees.salary = (SELECT MIN_SALARY FROM jobs where employees.job_id=jobs.job_id);
+------------+------------+---------+----------+
...
MariaDB [CSD2204S18]> SELECT first_name,last_name,salary, department_id FROM employees WHERE salary>(SELECT avg(salary) FROM employees) AND department_id IN (SELECT department_id FROM department_name LIKE 'IT%');
ERROR 1064 (42000): You have an error in your SQL syntax; check the manual that corresponds to your MariaDB server version for the right syntax to use near 'LIKE 'IT%')' at line 1
